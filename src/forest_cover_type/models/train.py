...
def train(dataset_path, save_model_path, save_best_model_path, random_state, use_scaler, logreg_c, max_iter, k_folds, model, n_estimators, max_depth, min_samples_split):
    ...
    with mlflow.start_run(run_name=model):
        ...
        pipeline = make_pipeline(model=model, use_scaler=use_scaler,
                                 logreg_c=logreg_c, max_iter=max_iter, random_state=random_state, n_estimators=n_estimators, max_depth=max_depth, min_samples_split=min_samples_split)
